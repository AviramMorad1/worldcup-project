...
LEAGUE_FILES: list[tuple[Path, str]] = [
    ...
    (Path("datasets/Czech First League Stats.csv"),       "cz Czech First League"),
    (Path("datasets/Scottish Premiership Stats.csv"),    "sco Scottish Premiership"),
    (Path("datasets/Danish Superliga Stats.csv"),       "dk Danish Superliga"),
    (Path("datasets/Super League Greece Stats.csv"),   "gr Super League Greece"),
    (Path("datasets/Swiss Super League Stats.csv"),     "ch Swiss Super League"),
    (Path("datasets/A-League Men Stats Australia.csv"), "au A-League Men"),
    (Path("datasets/Liga MX Stats.csv"),               "mx Liga MX"),
]
