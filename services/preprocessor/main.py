...
TEAM_KEYWORDS: dict[str, list[str]] = {
    # ── Group A ──────────────────────────────────────────────────────────────
    "Mexico":                 ["mexico", "el tri", "santi gimenez",
                               "lozano", "jimenez", "ochoa", "antuna"],
    "Korea Republic":         ["south korea", "korea republic", "korean",
                               "taeguk warriors", "son heung", "son",
                               "lee kang", "hwang hee", "kim min jae",
                               "cho gue"],
    "South Africa":           ["south africa", "bafana bafana", "percy tau",
                               "ronwen williams", "mofokeng", "zwane",
                               "dlamini"],
    "Czechia":                ["czechia", "czech republic", "czech",
                               "schick", "soucek", "hlozek", "kuchta",
                               "jurasek", "kral", "lingr"],
    # ── Group B ──────────────────────────────────────────────────────────────
    "Canada":                 ["canada", "canmnt", "canadians",
                               "alphonso davies", "jonathan david",
                               "buchanan", "larin", "adekugbe"],
    "Bosnia and Herzegovina": ["bosnia", "bosnia and herzegovina",
                               "zmajevi", "dragons", "dzeko",
                               "demirovic", "kolasinac", "krunic",
                               "cimirot"],
    "Qatar":                  ["qatar", "al annabi", "maroons",
                               "akram afif", "almoez ali", "al haydos",
                               "boudiaf", "muntari"],
    "Switzerland":            ["switzerland", "swiss nati", "nati",
                               "xhaka", "sommer", "embolo", "vargas",
                               "ndoye", "aebischer", "freuler"],
    # ── Group C ──────────────────────────────────────────────────────────────
    "Haiti":                  ["haiti", "les grenadiers", "grenadiers",
                               "haitian", "bikel", "lamothe", "joseph",
                               "bourgeau"],
    "Brazil":                 ["brazil", "brasil", "selecao", "seleção",
                               "vinicius", "rodrygo", "raphinha", "endrick",
                               "militao", "marquinhos", "alisson", "savinho",
                               "paqueta"],
    "Scotland":               ["scotland", "tartan army", "scots", "scottish",
                               "mctominay", "robertson", "mcgregor", "gilmour",
                               "tierney", "adams", "mckenna"],
    "Morocco":                ["morocco", "atlas lions", "hakimi", "amrabat",
                               "ounahi", "en nesyri", "aguerd", "boufal",
                               "mazraoui"],
    # ── Group D ──────────────────────────────────────────────────────────────
    "United States":          ["usa", "united states", "usmnt", "pulisic",
                               "reyna", "dest", "mckennie", "musah",
                               "aaronson", "turner", "ferreira", "weah"],
    "Australia":              ["australia", "socceroos", "leckie", "irvine",
                               "ryan", "hrustic", "kuol", "goodwin"],
    "Paraguay":               ["paraguay", "la albirroja", "albirroja",
                               "sanabria", "enciso", "almiron", "gamarra",
                               "romero", "villasanti"],
    "Türkiye":                ["turkey", "turkiye", "türkiye", "turkish",
                               "calhanoglu", "guler", "yildiz", "demiral",
                               "akaydin", "kabak"],
    # ── Group E ──────────────────────────────────────────────────────────────
    "Côte d'Ivoire":          ["ivory coast", "cote d ivoire", "côte d'ivoire",
                               "elephants", "les elephants", "haller",
                               "kessie", "sangare", "aurier", "gradel"],
    "Germany":                ["germany", "deutschland", "die mannschaft",
                               "wirtz", "musiala", "havertz", "kimmich",
                               "rudiger", "ter stegen", "sane", "gnabry"],
    "Ecuador":                ["ecuador", "tricolor", "tri color",
                               "caicedo", "plata", "hincapie", "mena",
                               "estrada", "ibarra"],
    "Curaçao":                ["curacao", "curaçao", "van aanholt",
                               "meyer", "vranjes", "marchena"],
    # ── Group F ──────────────────────────────────────────────────────────────
    "Netherlands":            ["netherlands", "holland", "oranje", "dutch",
                               "van dijk", "dumfries", "gakpo", "de jong",
                               "frimpong", "timber", "de ligt", "bergwijn"],
    "Sweden":                 ["sweden", "sverige", "blågult", "blagult",
                               "isak", "forsberg", "lindelof", "gyokeres",
                               "kulusevski", "elanga", "ekdal"],
    "Japan":                  ["japan", "samurai blue", "kubo", "doan",
                               "minamino", "ueda", "endo", "tanaka",
                               "tomiyasu", "mitoma"],
    "Tunisia":                ["tunisia", "carthage eagles", "eagles of carthage",
                               "khazri", "maaloul", "laaidouni",
                               "ben slimane", "jaziri"],
    # ── Group G ──────────────────────────────────────────────────────────────
    "IR Iran":                ["iran", "ir iran", "team melli", "taremi",
                               "azmoun", "jahanbakhsh", "hosseini",
                               "mohammadi", "ghoddos"],
    "Belgium":                ["belgium", "red devils", "de bruyne",
                               "lukaku", "courtois", "doku", "openda",
                               "onana", "tielemans"],
    "New Zealand":            ["new zealand", "all whites", "kiwis",
                               "wood", "bell", "cacace", "rojas", "waine"],
    "Egypt":                  ["egypt", "pharaohs", "salah", "el shahat",
                               "nasser maher", "kahraba", "hamdy"],
    # ── Group H ──────────────────────────────────────────────────────────────
    "Saudi Arabia":           ["saudi arabia", "saudi", "green falcons",
                               "al dawsari", "firas al buraikan",
                               "al bulayhi", "al shahrani"],
    "Spain":                  ["spain", "espana", "la roja", "pedri",
                               "yamal", "morata", "fabian", "rodri",
                               "cucurella", "unai simon", "nico williams",
                               "inaki williams"],
    "Uruguay":                ["uruguay", "celeste", "los charruas",
                               "valverde", "nunez", "darwin", "bentancur",
                               "araujo", "de arrascaeta", "olivera"],
    "Cabo Verde":             ["cabo verde", "cape verde", "blue sharks",
                               "tavares", "andrade", "dias", "fortes",
                               "ryan mendes"],
    # ── Group I ──────────────────────────────────────────────────────────────
    "France":                 ["france", "french", "les bleus", "mbappe",
                               "griezmann", "dembele", "camavinga",
                               "tchouameni", "kounde", "maignan", "cherki",
                               "barcola", "deschamps"],
    "Iraq":                   ["iraq", "lions of mesopotamia", "mesopotamia",
                               "ali adnan", "mohanad ali", "bashar resan",
                               "amjed attwan"],
    "Senegal":                ["senegal", "teranga lions", "lions de la teranga",
                               "mane", "koulibaly", "sarr", "diatta",
                               "faye", "balde"],
    "Norway":                 ["norway", "norge", "haaland", "odegaard",
                               "sorloth", "thorstvedt", "pedersen", "berge",
                               "nusa"],
    # ── Group J ──────────────────────────────────────────────────────────────
    "Argentina":              ["argentina", "argentine", "albiceleste",
                               "messi", "lautaro", "julian alvarez",
                               "enzo fernandez", "mac allister", "de paul",
                               "otamendi", "scaloni"],
    "Austria":                ["austria", "team austria", "alaba",
                               "arnautovic", "sabitzer", "laimer",
                               "wimmer", "gregoritsch"],
    "Algeria":                ["algeria", "fennecs", "des fennecs",
                               "mahrez", "belaili", "zerrouki",
                               "bensebaini", "benrahma"],
    "Jordan":                 ["jordan", "nashama", "al nashama",
                               "al tamari", "bani yaseen", "almomani",
                               "shretah"],
    # ── Group K ──────────────────────────────────────────────────────────────
    "Portugal":               ["portugal", "selecao das quinas", "quinas",
                               "ronaldo", "cristiano", "leao", "cancelo",
                               "bernardo silva", "vitinha", "felix", "dalot"],
    "Uzbekistan":             ["uzbekistan", "white wolves", "shomurodov",
                               "tursunov", "alijonov", "abdusalomov"],
    "Congo DR":               ["congo dr", "congo", "democratic republic congo",
                               "leopards", "batshuayi", "lukebakio",
                               "masuaku", "akolo"],
    "Colombia":               ["colombia", "cafeteros", "luis diaz",
                               "james rodriguez", "cuadrado", "arias",
                               "cordoba", "vasquez"],
    # ── Group L ──────────────────────────────────────────────────────────────
    "Ghana":                  ["ghana", "black stars", "kudus", "ayew",
                               "partey", "williams", "mensah", "salisu"],
    "England":                ["england", "three lions", "kane", "bellingham",
                               "saka", "rashford", "trippier", "gordon",
                               "palmer", "alexander arnold"],
    "Panama":                 ["panama", "los canaleros", "canaleros",
                               "godoy", "carrasquilla", "davis", "cox",
                               "arroyo"],
    "Croatia":                ["croatia", "vatreni", "modric", "gvardiol",
                               "kovacic", "kramaric", "livakovic", "brozovic",
                               "sucic"],
}
